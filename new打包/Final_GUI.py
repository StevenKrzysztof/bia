...
class SecondWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.recommend_button_1.setText("Weifan Wang") # 设置按钮文本
        self.recommend_button_1.setIcon(QtGui.QIcon('./q11.jpg')) # 设置按钮图标
        ...
        self.recommend_button_2.setText("Siyu Lin")
        self.recommend_button_2.setIcon(QtGui.QIcon('./q22.jpg'))
        ...
        self.recommend_button_3.setText("Chenxi Yu")
        self.recommend_button_3.setIcon(QtGui.QIcon('./q33.jpg'))
        ...
        self.recommend_button_4.setText("Zhiwen Yan")
        self.recommend_button_4.setIcon(QtGui.QIcon('./q44.jpg'))
...
class FakeWindow2(QWidget):
    ...
    def init_ui(self):
        ...
        self.right_recommend_label1 = QtWidgets.QLabel("Here is to read for help")
        self.right_recommend_label1.setObjectName('right_lable')
        self.right_recommend_label2 = QtWidgets.QLabel("Left board is the main Menu")
        self.right_recommend_label2.setObjectName('right_lable')
        self.right_recommend_label3 = QtWidgets.QLabel("You can choose the function you want")
        ...
        self.right_layout.addWidget(self.right_recommend_label1, 1, 0, 1, 9, Qt.AlignTop)
        self.right_layout.addWidget(self.right_recommend_label2, 2, 0, 1, 9, Qt.AlignTop)
        self.right_layout.addWidget(self.right_recommend_label3, 3, 0, 1, 9, Qt.AlignTop)
...
class scan_pay(QWidget):
    ...
    def do_btn31(self, event): # 文件：文件夹
      dir = QFileDialog.getExistingDirectory(self, 
                  "选取文件夹", 
                  "C:/")         # 起始路径
      resultofSeg = Segmentation(self,dir)
      self.echo(dir)
    ...
    def do_btn34(self, event): # 文件：另存为
      file_, ok = QFileDialog.getSaveFileName(self, 
                  "文件另存为", 
                  "C:/", 
                  "All Files (*);;Text Files (*.txt)")
    ...
    def init_ui(self):
        ...
        self.right_recommend_label1 = QtWidgets.QLabel("File Processing")
        self.right_recommend_label1.setObjectName('right_lable')
        ...
        self.recommend_button_11.setText("Single file") # 设置按钮文本
        self.recommend_button_11.clicked.connect(self.do_btn31)
        self.recommend_button_11.setIcon(QtGui.QIcon('./single.png')) # 设置按钮图标
        ...
        self.recommend_button_12.setText("muti files")
        self.recommend_button_12.clicked.connect(self.do_btn32)
        self.recommend_button_12.setIcon(QtGui.QIcon('./multiple.png'))
        ...
        self.recommend_button_13.setText("save")
        self.recommend_button_13.clicked.connect(self.do_btn33)
        self.recommend_button_13.setIcon(QtGui.QIcon('./save.png'))
        ...
        self.recommend_button_14.setText("save as")
        self.recommend_button_14.clicked.connect(self.do_btn34)
        self.recommend_button_14.setIcon(QtGui.QIcon('./save.png'))
        self.recommend_button_14.setIconSize(QtCore.QSize(50, 50))
        ...
        self.right_recommend_layout.addWidget(self.recommend_button_13, 1, 0)
        self.right_recommend_layout.addWidget(self.recommend_button_14, 1, 1)
...
class scan_us(QWidget):
    ...
    def init_ui(self):
        ...
        menu1=QMenu()
        sub_menu1 = QMenu(menu1)
        act1 = QAction(QIcon("menu.ico"), "Weifan.18@intl.zju.edu.cn",menu1)
        #act2 = QAction(QIcon("menu.ico"), "detection",menu1)
        ...
        self.recommend_button_1.setIconSize(QtCore.QSize(200,200)) # 设置图标大小
        self.recommend_button_1.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon) # 设置按钮形式为上图下文
        self.recommend_button_1.setAutoRaise(True)
        self.recommend_button_1.setMenu(menu1)
        ...
        self.recommend_button_5.setText("Feiyu Chen")
        self.recommend_button_5.setIcon(QtGui.QIcon('./q55.jpg'))
        ...
        self.recommend_button_6.setText("Ziyang Wang")
        self.recommend_button_6.setIcon(QtGui.QIcon('./q66.jpg'))
...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_button_2 = QtWidgets.QPushButton(qtawesome.icon('fa.heart',color='white'),"Our Information")
        ...
        self.left_button_6 = QtWidgets.QPushButton(qtawesome.icon('fa.download',color='white'),"File Processing")
        self.left_button_6.clicked.connect(self.CheckOut)
    ...
    def video(self):
        ...
        video1.show()
        sys.exit(QApplication(sys).exec_())  
    ...
    def Segmentation(self,img_path):
        ...
        res = Segmentationv5.get_mask(img_path)
        return res
