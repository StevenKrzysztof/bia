...
class SecondWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.right_recommend_label2 = QtWidgets.QLabel("Click to see division of work")
...
class MainUi(QtWidgets.QMainWindow):
    ...
    def Segmentation(self):
        Segmentation_window = scan_pay("Segmentation",self.main_layout)
        self.windowList.append(Segmentation_window)
        # 先关闭第一个窗口,视觉上好看
        self.right_widget.right_widget.close()
