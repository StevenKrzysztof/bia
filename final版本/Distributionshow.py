...
#select the mask from the output path and show
    def set_image(self, Distripath):
        
        Distripath = './distribution.png'
        self.img = QPixmap(Distripath)
...
class MainDemo(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Distribution Show")
        ...
        Distriname = ('./distribution.png')
        self.box.set_image(Distriname)
        self.update()
